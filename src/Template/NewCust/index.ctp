    ...
    <section id="services">
        <div class="container">
            <div class="row">
                <div class="col-lg-12 text-center">
                    <h2 class="section-heading">Which community are you a member of?</h2>
                    <hr class="primary">
                </div>
            </div>
        </div>
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-centered text-center">
                    <div class="service-box">
                        <a href="/Information?canterbury">
                        <i class="fa fa-4x fa-home wow bounceIn text-primary" data-wow-delay=".1s" style="color:blue;"></i>
                        </a>
                        <h3>Canterbury</h3>
                    </div>
                </div>
                <div class="col-lg-3 col-md-6 col-right text-center">
                    <div class="service-box">
                        <a href="/Information?bridgemore">
                        <i class="fa fa-4x fa-home wow bounceIn text-primary" data-wow-delay=".3s" style="color:green;"></i>
                        </a>
                        <h3>Bridgemore</h3>
                    </div>
                </div>
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6 col-right text-center">
                    <div class="service-box">
                        <a href="/Information?generals">
                        <i class="fa fa-4x fa-home wow bounceIn text-primary" data-wow-delay=".3s" style="color:red;"></i>
                        </a>
