        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-8 col-lg-offset-2 text-center">
                    ...
                    <p id="a13" class="answer" style="display:none;">On the back of your router, you will see a power adapter.  Unplug the power adapter for 10-20 seconds.  Plug the power adapter back into the router. Wait a minute for the router to reboot. Also check to see if the ethernet cable is securely plugged into the router.  To see a video tutorial, go to www.crystalclearfiber.com, click on “Learn More” at the top of the page, click on “Video Tools” and view the video.</p>
                    <br>  
                    <h3 class="question" id="q14" onclick="hide_unhide(this)">How do I reboot my ONT (Optical Network Terminal)?</h3>
                    <p id="a14" class="answer" style="display:none;">In the low voltage panel of your home, you will see the ONT (Optical Network Terminal) box.  There will be a black power adapter that connects the ONT to the power source. To reboot, you can unplug the power adapter directly from the power source or unplug the power adapter from the ONT by pressing the pin and pull straight down.  Wait 10-20 seconds and plug the power adapter either back into the power source or back into the ONT. The ONT will take approximately two (2) minutes to reboot.  When you see two (2) green lights, the ONT is rebooted.  You never want to push the reset button on the ONT as it will lose its configuration and a technician will have to come out to your home to restore services, if pressed.  To see a video tutorial, go to www.crystalclearfiber.com, click on “Learn More” at the top of the page, click on “Video Tools” and view the video.</p>
                    <br>  

                    
                    <p>For all other questions feel free to contact us at 615-550-4600 or support@crystalclearfiber.com.</p>    
